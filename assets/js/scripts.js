...
!function (NioApp, $) {
  ...
  NioApp.DataTable = function (elm, opt) {
    if ($(elm).exists()) {
      $(elm).each(function () {
        ...
        // $(this).DataTable(attr).ajax.reload();
        // }, 2000);
  ...
  NioApp.DataTable.init = function () {
    ...
    NioApp.DataTable('.datatable-init-show', {
      pageLength: 5,
      ...
      buttons: [
        {
          ...
          exportOptions: {
            // columns: ':visible'
            // columns: [':visible:not(.not-export-col):not(.hidden):not(:contains(Action))'],
    ...
    NioApp.DataTable('.datatable-init-export2', {
      responsive: {
        details: true,
        // details: {
        //   display: $.fn.dataTable.Responsive.display.modal({
    ...
    NioApp.DataTable('.datatable-init-export_info', {
      responsive: {
        details: true,
        // details: {
        //   display: $.fn.dataTable.Responsive.display.modal({
    ...
    NioApp.DataTable('.datatable-init-export_peminjaman', {
      responsive: {
        details: true,
        // details: {
        //   display: $.fn.dataTable.Responsive.display.modal({
    ...
    NioApp.DataTable('.datatable-init-export_action1asc', {
      responsive: {
        details: true,
      },
      order: [[1, 'asc']],
    ...
    NioApp.DataTable('.datatable-init-export_action1desc', {
      responsive: {
        details: true,
      },
      order: [[1, 'desc']],
    ...
    NioApp.DataTable('.datatable-init-export_noaction1asc', {
      responsive: {
        details: true,
      },
      order: [[0, 'asc']],
    ...
    var abc = NioApp.DataTable('.datatable-init-export_noaction1desc', {
    ...
    // setInterval(abc.fnReloadAjax(), 2000);
    // setInterval(abc.ajax.reload(null, false), 2000);


    NioApp.DataTable('.datatable-init-export_colvis1asc', {
      responsive: {
        details: true,
      },
      order: [[0, 'asc']],
    ...
    NioApp.DataTable('.datatable-init-export_colvis1desc', {
      responsive: {
        details: true,
      },
      order: [[0, 'desc']],
  ...
  NioApp.DataTable('.datatable-init-export_action_proyek_desc', {
    responsive: {
      details: true,
    },
    order: [[11, 'desc']],
