                            ...
                            <div class="nk-content-body">
                                <div>
                                    <ul class="nav nav-tabs nav-tabs-s2">
                                        ...
                                        <li class=" nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#" onclick="eksiturev()">EKSITU</a>
                                        </li>
                                        <li class=" nav-item">
                                                        ...
                                                        <table class="datatable-init-export_action1asc wrap table fs-12px" data-export-title="Export">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center">Jumlah Eksitu</th>
                                                                    <th>Koordinator</th>
                                                                    <th class="text-center">Tanggal Pekerjaan</th>
                                                                    <th class="text-center">Detail Alat</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><?= $detailAlat; ?></td>
                                                                            <td class="text-center"><?= $row['eksitu_proyek']; ?></td>
                                                                            <td class="text-center"><?= $row['eksitu_progres_proyek']; ?></td>
