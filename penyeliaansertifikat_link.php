...
if (isset($_REQUEST['uid'])) {
    ...
    if ($row0['status1_proyek'] == 1) $edit = 1;
    else $edit = 0;
...
<body class="nk-body bg-lighter npc-default has-sidebar ">
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            <h3>Data Penyeliaan Sertifikat</h3>
                                        </div>
                                        <div class="nk-block-head-content">
                                                ...
                                                <div class="preview-block">
                                                    ...
                                                    <form id="hl_form" name="hl_form" class="form-validate is-alter"
                                                        ...
                                                        <input type="hidden" id="form_name" name="form_name"
                                                            value="add_sertifikat2" />
                                                        <input type="hidden" id="id_sertifikat" name="id_sertifikat"
                                                            value="0" />
                                                        <input type="hidden" id="link_sertifikat" name="link_sertifikat"
                                                            value="" />
        ...
        $(document).on('click', '.btn-edit', function(ev) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    // console.log(result);
                    $("#form_name").val("edit_sertifikat2");
    ...
    function sertifikat_qr(namapelanggan) {
        ...
        //SERTIFIKAT SALAH (masih dibuatkan backup)
        // let url = 'https://pt-einsten.com/easy2/pelanggan?uid=' + namapelanggan;
