...
if (isset($_REQUEST['uid'])) {
    ...
    $query3 = "SELECT * FROM pelanggan WHERE id_pelanggan =  '$idpelanggan'";
    $result3 = mysqli_query($conn, $query3) or die(mysqli_error($conn));
    $row3 = mysqli_fetch_assoc($result3);
    $namapelanggan = $row3['nama_pelanggan'];

    if ($row2['tingkat_status'] == 5) $editMode = 1;
}
?>
...
<body class="nk-body bg-lighter npc-default has-sidebar ">
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Tambah Event | <?= $row0['no_proyek']; ?></h5>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="event-title"
                                                        value="<?= $namapelanggan; ?>" name="nama_kegiatan" required
                                                        readonly data-msg="Mohon isi nama event">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control " id="edit-event-title"
                                                        name="nama_kegiatan" placeholder="Nama event" required readonly
    ...
    $(document).ready(function(e) {
        ...
        document.title = 'Event ' + '<?= $row0['no_proyek']; ?>';
    ...
    function ceketgl() {
        let tgl1 = $('#event-start-date').val();
        let tgl2 = $('#event-end-date').val();
        if (tgl2 <= tgl1) $('#event-end-date').val('');
    }

    function cekeditetgl() {
        let tgl1 = $('#edit-event-start-date').val();
        let tgl2 = $('#edit-event-end-date').val();
        if (tgl2 <= tgl1) $('#edit-event-end-date').val('');
    }
        ...
        NioApp.Calendar = function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventClick: function eventClick(info) {
                    ...
                    if (info.event._def.extendedProps.no_proyek !== ' | <?=$row0['no_proyek'];?>') {
                        $('#btn-ubah').hide();
                        $('#btn-hapus').hide();
                    } else {
                        $('#btn-ubah').show();
