...
<body class="nk-body bg-lighter npc-default has-sidebar ">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-s2">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#"
                                                onclick="home()">PROJECTS</a>
                                        </li>
                                        <li class=" nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#"
                                                onclick="insiturev()">INSITU</a>
                                        </li>
                                        <li class=" nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#"
                                                onclick="eksiturev()">EKSITU</a>
                                        </li>
                                        <li class=" nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#"
                                                onclick="subkonrev()">SUB-KON</a>
                                        </li>
                                    </ul>
                                            ...
                                            <div class="nk-block nk-block-lg">
                                                <div class="card">
                                                    ...
                                                    <div class="card-inner">
                                                        <table
                                                            class="datatable-init-export_action1asc wrap table fs-12px"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-left">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li>
                                                                                    <a href="#" id="<?= $id_proyek; ?>"
                                                                                        class="toggle btn-down"><em
                                                                                            class="icon ni ni-arrow-down-circle-fill"></em><span>Proyek
                                                                                            Down</span></a>
                                                                                </li>
                                                                                <li>
                                                                                    <a href="#" id="<?= $id_proyek; ?>"
                                                                                        class="toggle btn-finish"><em
                                                                                            class="icon ni ni-check-circle-fill"></em><span>Proyek
                                                                                            Selesai</span></a>
                                                                                </li>
                                                                                <li>
                                                                                    <a href="#" id="<?= $id_proyek; ?>"
                                                                                        class="toggle btn-cancel"><em
                                                                                            class="icon ni ni-cross-circle-fill"></em><span>Proyek
                                                                                            Batal</span></a>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <a href="#"
                                                                            onclick="proyekrev_detail(<?= $row['id_proyek']; ?>)"><?= $row['no_proyek']; ?></a>
                                                                    </td>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <?= date("d F Y", strtotime($row['tglorder_proyek'])); ?>
                                                                    </td>
                                                                    <td><?= $row['catatan_proyek']; ?></td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-left">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li>
                                                                                    <a href="#" id="<?= $id_proyek; ?>"
                                                                                        class="toggle btn-up"><em
                                                                                            class="icon ni ni-arrow-up-circle-fill"></em><span>Proyek
                                                                                            Up</span></a>
                                                                                </li>
                                                                                <li>
                                                                                    <a href="#" id="<?= $id_proyek; ?>"
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-left">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                ...
                                                                                <li>
                                                                                    <a href="#" id="<?= $id_proyek; ?>"
                                                                                        class="toggle btn-back"><em
                                                                                            class="icon ni ni-swap"></em><span>Proyek
                                                                                            On-Going</span></a>
                                                                                </li>
                                                                                <li>
                                                                                    <a href="#" id="<?= $id_proyek; ?>"
                                ...
                                <div class="nk-add-product toggle-slide toggle-slide-right" data-content="addProyek"
                                    ...
                                    <div class="nk-block">
                                        <form id="hl_form" name="hl_form" class="form-validate is-alter"
                                            ...
                                            <input type="hidden" id="nama_pelanggan2" name="nama_pelanggan2"
                                                value="0" />
                                            ...
                                            <div class="row g-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control date-picker invalid"
                                                                data-date-format="yyyy-mm-dd" id="tglorder_proyek"
                                                                name="tglorder_proyek" required
                                                                data-msg="Mohon isi tglorder proyek">
                                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control invalid"
                                                                id="namapemilik_proyek" name="namapemilik_proyek"
                                                                placeholder="Nama Pemilik Sertifikat" required
                                                                data-msg="Mohon isi Nama Pemilik Sertifikat">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control invalid"
                                                                id="alamatpemilik_proyek" name="alamatpemilik_proyek"
                                                                placeholder="Alamat Pemilik Sertifikat" required
                                                                data-msg="Mohon isi Alamat Pemilik Sertifikat">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label class="form-label" for="permohonan_proyek">Permohonan
                                                            Diterima Melalui</label>
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control invalid"
                                                                id="permohonan_proyek" name="permohonan_proyek"
                                                                placeholder="Permohonan Diterima Melalui" required
                                                                data-msg="Mohon isi Permohonan Diterima Melalui">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control invalid"
                                                                id="catatan_proyek" name="catatan_proyek"
                                                                placeholder="Mohon isi catatan proyek" required
                                                                data-msg="Mohon isi Permohonan Diterima Melalui">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label class="form-label" for="insitu_proyek">Realisasi
                                                            Insitu</label>
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control invalid"
                                                                id="insitu_proyek" name="insitu_proyek"
                                                                placeholder="Realisasi Insitu">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control invalid"
                                                                id="insitu_progres_proyek" name="insitu_progres_proyek"
                                                                placeholder="Catatan Insitu">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label class="form-label" for="eksitu_proyek">Realisasi
                                                            eksitu</label>
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control invalid"
                                                                id="eksitu_proyek" name="eksitu_proyek"
                                                                placeholder="Realisasi eksitu">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control invalid"
                                                                id="eksitu_progres_proyek" name="eksitu_progres_proyek"
                                                                placeholder="Catatan eksitu">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label class="form-label" for="subkon_proyek">Realisasi
                                                            subkon</label>
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control invalid"
                                                                id="subkon_proyek" name="subkon_proyek"
                                                                placeholder="Realisasi subkon">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control invalid"
                                                                id="subkon_progres_proyek" name="subkon_progres_proyek"
                                                                placeholder="Catatan subkon">
                                                        </div>
                                                    </div>
                                                </div>
    ...
    $(document).ready(function(e) {
        ...
        $(document).on('click', '.btn-back', function(ev) {
            ev.preventDefault();
            var tbl_id = $(this).attr("id");

            Swal.fire({
                title: 'Apakah kembalikan proyek?',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Ya, kembali On-Going!'
            }).then(function(result) {
                if (result.value) {
                    // hapus data
                    $.post('save_details.php', {
                        form_name: "back_proyek",
                        tbl_id: tbl_id
                    }, function(data, status) {
                        console.log(data);
                        if (data == "1") {
                            Swal.fire({
                                icon: "success",
                                title: "Status proyek telah dikembalikan.",
                                showConfirmButton: false,
                                timer: 1500,
                            });
                            setTimeout(function() {
                            ...
                            Swal.fire({
                                icon: "error",
                                title: "Status proyek gagal dikembalikan.",
                                showConfirmButton: false,
                                timer: 1500,
                            });
                        } else {
