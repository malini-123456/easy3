                            ...
                            <?php if ($row_session['posisi_user'] == 'SA') { ?>
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
										...
										<div class="nk-block-head-content">
                                                <button class=" btn btn-round btn-warning" data-toggle="modal" data-target="#Tutorial">Tutorial</button>
                                            </div><!-- .nk-block-head-content -->
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-body">
                                                            <form method="post" enctype="multipart/form-data" class="mb-3" id="uploadForm">
                                                                ...
                                                                <button type="submit" name="submit" id="submit_btn" class="btn btn-primary">Submit</button>
                                                            </form>
                                                            <!-- <h3>List File</h3> -->
