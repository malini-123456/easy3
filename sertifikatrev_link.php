                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Data Sertifikat - <?= $row1['nama_pelanggan']; ?></h3>
                                            <?php $namapelanggan = $row1['nama_pelanggan']; ?>
                                                                        ...
                                                                        <div class="card card-preview">
                                                                            <div class="card-inner">
                                                                                <table class="datatable-init-export_action1asc wrap table" data-export-title="Export">
                                                                                    ...
                                                                                    ?>
                                                                                    <a href="#" onclick="lampiran_pdf(<?= $row_proyek['id_proyek']; ?>)" class="btn btn-round btn-dim btn-outline-info"><em class="icon ni ni-printer-fill"></em><span>Lampiran</span></a>
                                                                                    &emsp;
