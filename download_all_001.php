<?php
    ...
    $result = mysqli_query($conn, "SELECT * FROM tb_multiple WHERE status=1");
    while ($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
    {
        mysqli_query($conn, "UPDATE tb_multiple set status=2 WHERE id='" . $row['id'] . "'");
    ...
    header('Location: https://pt-einsten.com/easy3/upload');
?>