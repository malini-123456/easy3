...
<page backcolor="#FFFFFF" backtop="9mm" backbottom="6mm" style="font-size: 10px;">
    <!-- #FEFEFE -->
    ...
    <table id="myTable" border="0.0px" cellspacing="0"
        style="width: 90%; text-align: center; font-size: 10px; padding-top: 0px; margin-left: 50px; color: #000000; ">
        <colgroup>
            <col style="width: 15%; padding: 2px 0px; margin-left: 43px;">
            <col style="width: 4%; padding: 2px 0px;">
            <col style="width: 1%; padding: 2px 0px; padding-right: 40px;">
        ...
        <tr>
            <td colspan="2"
                style="border: 0.05px; border-left: 2px; border-top: 2px; width: 19%; background-color: #009944; color: #ffffff;">
                <b>PT
                    ELEKTROMEDIKA INSTRUMEN
                    TERA NUSANTARA</b>
            </td>
            <td style="width: 1%; border: 0px; border-left: 2px;"></td>
            <td colspan=" 2"
                style="border: 0.05px; border-left: 2px; border-top: 2px; width: 19%; background-color: #009944; color: #ffffff;">
                <b>PT
                    ELEKTROMEDIKA
        ...
        <tr>
            <td colspan="2"
                style="border: 0.05px; border-left: 2px; border-top: 2px; width: 19%; background-color: #d42225; color: #ffffff;">
                <b>PT
                    ELEKTROMEDIKA INSTRUMEN
                    TERA NUSANTARA</b>
            </td>
        ...
        <?php
                        ...
                        ?>
        <tr>
            <td rowspan="3" style="border: 0.05px; border-left: 2px; width: 14%;"><img style="width: 90%;"
                    src="./images/img/cek_isi_3.png"></td>
            <td style="border: 0.05px;width: 5%;"><img style=" width: 99%;"
                    src="./images/img/stiker/H/H<?= $angka1; ?>.png"></td>
            <td style="width: 1%; border: 0px;border-left: 2px;"></td>
            <td rowspan="3" style="border: 0.05px;border-left: 2px;width: 14%;"><img style="width: 90%;"
                    src="./images/img/cek_isi_3.png"></td>
            <td style="border: 0.05px;width: 5%;"><img style=" width: 99%;"
        ...
        <tr>
            ...
            <td style="width: 1%; border: 0px; border-left: 2px; padding-right: 10px;"></td>
        ...
        <?php
                        ...
                        ?>
        <tr>
            <td colspan="2" style="border: 0.05px; border-left: 2px; border-bottom: 2px; width: 19%; font-size: 8px;">
                <b>DINYATAKAN AMAN
                    BAGI PEKERJA,
        ...
        <?php
                        ...
                        ?>
        <tr>
            <td colspan="2" style="border: 0.05px; border-left: 2px; border-bottom: 2px; width: 19%; font-size: 7.5px;">
                <b>DINYATAKAN TIDAK
                    AMAN
                    BAGI PEKERJA,
                    PENDERITA, DAN LINGKUNGAN</b>
