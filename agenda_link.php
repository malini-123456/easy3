                            ...
                            <div class="modal-body">
                                <div class="row gy-3 py-1">
                                    ...
                                    <div class="col-sm-10" id="preview-event-description-check">
                                        ...
                                        <!-- <p></p>
                                        <p id="preview-event-desc4" class="desc-space"></p>
                                        <p id="preview-event-desc5" class="desc-space"></p>
                                        <p id="preview-event-desc6" class="desc-space"></p>
                                        <p id="preview-event-desc7" class="desc-space"></p>
                                        <p id="preview-event-desc8" class="desc-space"></p>
                                        <p id="preview-event-desc9" class="desc-space"></p> -->
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        NioApp.Calendar = function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventClick: function eventClick(info) {
                    ...
                    // $('#preview-event-desc4').text('');
                    // $('#preview-event-desc5').text('');
                    // $('#preview-event-desc6').text('');
                    // $('#preview-event-desc7').text('');
                    // $('#preview-event-desc8').text('');
                    // $('#preview-event-desc9').text('');
                    // $('#preview-event-desc10').text('');
                    ...
                    // $('#preview-event-desc4').text(desc[4]);
                    // $('#preview-event-desc5').text(desc[5]);
                    // $('#preview-event-desc6').text(desc[6]);
                    // $('#preview-event-desc7').text(desc[7]);
                    // $('#preview-event-desc8').text(desc[8]);
                    // $('#preview-event-desc9').text(desc[9]);
                    // $('#preview-event-desc10').text(desc[10]);
