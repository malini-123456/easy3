                            ...
                            <div class="nk-content-body">
                                <div>
                                    <ul class="nav nav-tabs nav-tabs-s2">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#" onclick="home()">PROJECTS</a>
                                        </li>
                                        <li class=" nav-item">
                                        ...
                                        <li class=" nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#" onclick="subkonrev()">SUB-KON</a>
                                        </li>
                                    </ul>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-left">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    ...
                                                                                    <li>
                                                                                        <a href="#" id="<?= $id_proyek; ?>" class="toggle btn-delete"><em class="icon ni ni-trash-fill"></em><span>Delete Proyek</span></a>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-left">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    ...
                                                                                    <li>
                                                                                        <a href="#" id="<?= $id_proyek; ?>" class="toggle btn-back"><em class="icon ni ni-swap"></em><span>Proyek On-Going</span></a>
                                                                                    </li>
                                                                                    <li>
                                                                                        <a href="#" id="<?= $id_proyek; ?>" class="toggle btn-cancel"><em class="icon ni ni-cross-circle-fill"></em><span>Proyek Batal</span></a>
                                                                                    </li>
