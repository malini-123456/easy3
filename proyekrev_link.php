                                                    ...
                                                    <div class="card-inner">
                                                        <table class="datatable-init-export_action1asc wrap table fs-12px" data-export-title="Export">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                $sno = 0;
                                                                $query = "SELECT * FROM proyek WHERE status_proyek = 'ONGOING' ORDER BY id_proyek DESC";
                                                    ...
                                                    <div class="card-inner">
                                                        <table class="datatable-init-export_action1asc wrap table fs-12px" data-export-title="Export">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                $sno = 0;
                                                                $query = "SELECT * FROM proyek WHERE status_proyek = 'NEGO' ORDER BY id_proyek DESC";
                                                                $result = mysqli_query($conn, $query) or die(mysqli_error($conn));
                                                                while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label class="form-label" for="catatan_proyek">Catatan
                                                            Proyek</label>
                                                        <div class="form-control-wrap">
                                                            <textarea class="form-control" id="catatan_proyek" name="catatan_proyek" required data-msg="Mohon isi catatan proyek"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
