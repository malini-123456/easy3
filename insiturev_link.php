                            ...
                            <div class="nk-content-body">
                                <div>
                                    <ul class="nav nav-tabs nav-tabs-s2">
                                        ...
                                        <li class=" nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#" onclick="insiturev()">INSITU</a>
                                        </li>
                                        <li class=" nav-item">
                                                        ...
                                                        <table class="datatable-init-export_action1asc wrap table fs-12px" data-export-title="Export">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center">Jumlah Insitu</th>
                                                                    <th>Koordinator</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center"><?= $row['insitu_proyek']; ?></td>
                                                                            <td class="text-center"><?= $row['insitu_progres_proyek']; ?></td>
