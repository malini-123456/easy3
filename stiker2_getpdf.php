...
<page backcolor="#FFFFFF" backtop="4mm" backbottom="0mm" style="font-size: 1.7mm;">
    <!-- #FEFEFE -->
    ...
    <table id="myTable" border="0px" cellspacing="0"
        ...
        <tr>
            ...
            if ($status == 'hijau') {
            ?>
            <td colspan="3" style="width: 60mm; background-color: #009944; color: #ffffff; font-size: 2mm;"><b>PT
                    ELEKTROMEDIKA
        ...
        <tr>
            ...
            if ($status == 'hijau') {
            ?>
            <td style="width: 16mm;"><b>H<?= $angka1; ?></b></td>
            <?php
            } else {
            ?>
        ...
        <tr>
            ...
            if ($status == 'hijau') {
            ?>
            <td style="width: 16mm; background-color: #009944; color: #ffffff;">
                <b>LAIK PAKAI</b>
            </td>
            <?php
            } else {
        ...
        <tr>
            ...
            if ($status == 'hijau') {
            ?>
            <td colspan="3" style="width: 60mm; border-top:0.015mm"><b>DINYATAKAN AMAN BAGI PEKERJA, PENDERITA, DAN
                    LINGKUNGAN</b></td>
            <?php
            } else {
            ?>
            <td colspan="3" style="width: 60mm; font-size: 1.6mm; border-top:0.015mm"><b>DINYATAKAN TIDAK AMAN BAGI
                    PEKERJA, PENDERITA,
                    DAN
                    LINGKUNGAN</b></td>
            <?php
