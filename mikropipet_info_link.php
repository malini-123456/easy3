...
<body class="nk-body bg-lighter npc-default has-sidebar ">
                                                ...
                                                <div class="col-md-4 col-lg-4 col-xxl-4">
                                                    ...
                                                    <div class="product-meta">
                                                        <ul class="pricing-features">
                                                            ...
                                                            <li><span class="w-50">Volume</span><span
                                                                    class="ml-auto fs-16px fw-bold text-secondary"><?= $row0['volume']; ?></span>
                                                            </li>
                                                            <li><span class="w-50">Lokasi</span><span
                                                                    class="ml-auto fs-16px fw-bold text-secondary"><?= $row0['lokasi']; ?></span>
                                                            </li>
                                                ...
                                                <tbody>
                                                    <?php
                                                            ...
                                                            while ($row1 = mysqli_fetch_array($result1)) {
                                                                ...
                                                                $query2 = "SELECT * FROM peminjamanmikropipet WHERE no_proyek = '$noso'";
    ...
    $(document).ready(function(e) {
        document.title = 'Mikropipet | ' + '<?= $row0['no_seri']; ?>';
    });
