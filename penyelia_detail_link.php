                            ...
                            <div class="nk-content-body">
                                <div>
                                    <ul class="nav nav-tabs nav-tabs-s2">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#" onclick="create_account()">CREATE ACCOUNT</a>
                                        </li>
                                        <li class=" nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#" onclick="esertif()">E-SERTIFIKAT</a>
                                        </li>
                                    </ul>
                                            ...
                                            <div class="nk-block nk-block-lg">
                                                <div class="nk-block">
                                                    <div class="d-flex left-content-around">                                                        
                                                        <a href="#" class="btn btn-round btn-dim btn-outline-info"><em class="icon ni ni-printer-fill"></em><span>Akun Akses</span>
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="nk-block">
