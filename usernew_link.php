                    ...
                    <div class="container-fluid">
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                                ...
                                                <div class="preview-block">
                                                    <table class="datatable-init-export_action1asc nowrap table"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $query1 = "SELECT * FROM user WHERE username = '' ORDER BY id_user DESC";
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-left">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            <li>
                                                                                <a href="#"
                                                                                    onclick="user_qr('<?= $row1['nama_user']; ?>', '<?= $row1['telp_user']; ?>', '<?= $row1['email_user']; ?>', '<?= $row1['posisi_user']; ?>')"
                                                                                    class="toggle"><em
                                                                ...
                                                                <td class="nk-tb-col">
                                                                    <div class="user-card">
                                                                        <div
                                                                            class="user-avatar bg-white d-none d-sm-flex">
                                                                            <?php if ($row1['foto_user'] != '') { ?>
                                                                            <img
                                                                                src="./images/user/<?= $row1['foto_user']; ?>">
                                                                            <?php } else { ?>
                                                                        ...
                                                                        <div class="user-info">
                                                                            <span
                                                                                class="text-primary text-capitalize"><?= $row1['nama_user']; ?></span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td class="nk-tb-col"><?= $row1['join_user']; ?></td>
                                ...
                                <!-- add  -->
                                <div class="nk-add-product toggle-slide toggle-slide-right" data-content="addUser"
