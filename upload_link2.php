                                                ...
                                                <table class="datatable-init-export_action1asc nowrap table" data-export-title="Export">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td width='75'>
                                                                    <a href="#" id="<?= $pdfName; ?>" class="btn btn-icon btn-trigger btn-sm btn-delete" data-toggle="tooltip" data-placement="top" title="Delete"><em class="icon ni ni-trash-fill"></em></a>
                                                                </td>
                                                                <td width='75'><?= $sno; ?></td>
                                                                <td><a href="<?= $pdfName; ?>" target="_blank" class="toogle"><span><?= $file; ?></span></a></td>
                                                            </tr>
                                                        <?php
                                                        }
                                                        ?>
