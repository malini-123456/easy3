...
id_proyek ='$proyekid'";
        ...
        if ($row_jml_salinansertifikat != 0) {
            ...
            $result_linksertifikat = mysqli_query($conn, $query_linksertifikat) or die(mysqli_error($conn));
                                                    ...
                                                    <div class="team">
                                                        <div class="user-card user-card-s2">
                                                            ...
                                                            <div class="user-info">
                                                                ...
                                                                <span class="sub-text"><?= $row1['kategori_pelanggan']; ?></span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="nk-tb-list is-compact">
                                                            ...
                                                            <div class="nk-tb-item">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?= $row0['sumberdana_proyek']; ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?= 'Rp. ' . number_format($row0['pagu_proyek'], 0); ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?= $row1['kontak_pelanggan']; ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?= date_format(date_create($row0['deadline_proyek']), 'd F Y'); ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?= $row1['npwp_pelanggan']; ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?= $row1['namanpwp_pelanggan']; ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?= $row0['alatlaik_proyek']; ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?= $row0['jenisalat_proyek']; ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?= $row0['jmlalat_proyek']; ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            ...
                                                            <div class="nk-tb-item">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?= $row0['jmldana_proyek']; ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?= $row0['jadwalkerja_proyek']; ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?= $row0['daftarinventaris_proyek']; ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?= $row0['deadlinesertifikat_proyek']; ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?= $row0['catatan_proyek']; ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                            ...
                                                            <div class="nk-tb-item">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?php if ($row_jml_ph != 0) echo $row_penawaranharga['no_penawaranharga']; ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?php if ($row_jml_ph != 0) echo 'Rp. ' . number_format($row_penawaranharga['nilai_penawaranharga'], 0); ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span><?php if ($row_jml_nego != 0) echo 'Rp. ' . number_format($row_negosiasi['nilai_negosiasi'], 0); ?></span></span>
                                                                </div>
                                                            </div><!-- .nk-tb-item -->
                                                            <div class="nk-tb-item">
                                                                <div class="nk-tb-col">
                                                                ...
                                                                <div class="nk-tb-col text-right">
                                                                    <span class=" tb-amount"><span>
                                                                            <?php if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Marketing')) {
                                                                                if ($row2['tingkat_status'] > 4) {
                                                                                    if ($row_negosiasi['subkontrak_negosiasi'] == 'Ada') {
                                                                                        if (
                                                                                            ...
                                                                                            <button id="<?= $proyekid; ?>" class="btn btn-dim btn-outline-success btn-ok-proyekdetail">Selesai
                                                                                            </button>
                                                                                        <?php }
                                                                                    } else {
                                                                                ...
                                                                                <?php }
                                                                                if ($row2['tingkat_status'] < 5) { ?>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-dim btn-outline-danger btn-not-proyekdetail">Dibatalkan
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                        </span></span>
                                                            ...
                                                            <ul class="timeline-list">
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        <?php if ($row2['tingkat_status'] > 1) { ?>
                                                                            <strong class="tb-status text-success">Permintaan/Order</strong>
                                                                        <?php } else { ?>
                                                                            <strong class="tb-status text-muted">Permintaan/Order</strong>
                                                                        <?php } ?>
                                                                        <div class="timeline-des">
                                                                            <?php if ($row2['tingkat_status'] > 1) { ?>
                                                                                <br>
                                                                                <a href="<?= $row_order['link_permintaan_order']; ?>" target="_blank" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                            ...
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Admin Teknis')) {
                                                                                if ($row2['tingkat_status'] == 1) {
                                                                                    if ($row_jml_po == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-order">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } else { ?>
                                                                                        <br>
                                                                                        <button id="<?= $row_order['id_permintaan_order']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-order">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } ?>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-order">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            ...
                                                                            if ($row2['tingkat_status'] > 2) { ?>
                                                                                <br>
                                                                                <button onclick="kajiulang_pdf(<?= $proyekid; ?>)" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </button>
                                                                                <span>&nbsp;</span>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Admin Teknis')) {
                                                                                if ($row2['tingkat_status'] == 2) {
                                                                                    if ($row_jml_kjmain == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-kajiulang">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } else { ?>
                                                                                        <button id="<?= $row_kjmain['id_kajiulangmain']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-kajiulang">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } ?>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-kajiulang">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-kajiulang">
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row2['tingkat_status'] > 3) { ?>
                                                                                <br>
                                                                                <a href="<?= $row_penawaranharga['link_penawaranharga']; ?>" target="_blank" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </a>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Admin Umum')) {
                                                                                if ($row2['tingkat_status'] == 3) {
                                                                                    if ($row_jml_ph == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-tawar">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } else { ?>
                                                                                        <button id="<?= $row_penawaranharga['id_penawaranharga']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-penawaranharga">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } ?>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-penawaranharga">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-penawaranharga">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row2['tingkat_status'] > 4) { ?>
                                                                                <br>
                                                                                <a href="<?= $row_negosiasi['link_negosiasi']; ?>" target="_blank" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </a>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Marketing')) {
                                                                                if ($row2['tingkat_status'] == 4) {
                                                                                    if ($row_jml_nego == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-nego">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } else { ?>
                                                                                        <button id="<?= $row_negosiasi['id_negosiasi']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-negosiasi">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } ?>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-negosiasi">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-negosiasi">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        <?php if ($row2['tingkat_status'] > 5) { ?>
                                                                            <strong class="tb-status text-success">Penyusunan
                                                                                Jadwal</strong>
                                                                        <?php } else { ?>
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row2['tingkat_status'] > 5) { ?>
                                                                                <br>
                                                                                <button onclick="jadwal_pdf(<?= $proyekid; ?>)" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </button>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'PJ Teknis')) {
                                                                                if ($row2['tingkat_status'] == 5) { ?>
                                                                                    <br>
                                                                                    <button onclick="jadwal_page(<?= $proyekid; ?>)" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary">
                                                                                        <em class="icon ni ni-pen-fill"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-jadwal">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-jadwal">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row2['tingkat_status'] > 6) { ?>
                                                                                <br>
                                                                                <button onclick="spk_pdf(<?= $proyekid; ?>)" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </button>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Admin Teknis')) {
                                                                                if ($row2['tingkat_status'] == 6) {
                                                                                    if ($row_jml_spk == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-spk">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } else { ?>
                                                                                        <button id="<?= $row_spk['id_spk']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-spk">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } ?>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-spk">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-spk">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            ...
                                                                            if ($row2['tingkat_status'] > 7) { ?>
                                                                                <br>
                                                                                <button onclick="berkasteknisi_pdf(<?= $proyekid; ?>)" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </button>
                                                                                <span>&nbsp;</span>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Admin Teknis')) {
                                                                                if ($row2['tingkat_status'] == 7) { ?>
                                                                                    <br>
                                                                                    <button onclick="berkasteknisi_page(<?= $proyekid; ?>)" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary">
                                                                                        <em class="icon ni ni-pen-fill"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-berkasteknisi">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-berkasteknisi">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row_s1['tingkat_status1'] > 0 || $row_s2['tingkat_status2'] > 0 || $row_s3['tingkat_status3'] > 0) { ?>
                                                                                <br>
                                                                                <a href="<?= $row_lappekerjaan['link_lappekerjaan']; ?>" target="_blank" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </a>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Teknisi')) {
                                                                                if ($row2['tingkat_status'] == 8 && $row_s1['tingkat_status1'] == 0 && $row_s2['tingkat_status2'] == 0 && $row_s3['tingkat_status3'] == 0) {
                                                                                    if ($row_jml_lappekerjaan == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-lappekerjaan">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } else { ?>
                                                                                        <button id="<?= $row_lappekerjaan['id_lappekerjaan']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-lappekerjaan">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } ?>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-lappekerjaan">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-lappekerjaan">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                    ...
                                                    <div class="card-inner">
                                                        <div class="timeline">
                                                            ...
                                                            <ul class="timeline-list">
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        <?php if ($row_s1['tingkat_status1'] > 9) { ?>
                                                                            <strong class="tb-status text-success">Penyeliaan
                                                                                LK</strong>
                                                                        <?php } else { ?>
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row_s1['tingkat_status1'] > 9) { ?>
                                                                                <br>
                                                                                <button onclick="penyeliaansertifikat_page(<?= $proyekid; ?>)" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </button>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Penyelia')) {
                                                                                if ($row_s1['tingkat_status1'] == 9) { ?>
                                                                                    <br>
                                                                                    <button onclick="penyeliaansertifikat_page(<?= $proyekid; ?>)" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary">
                                                                                        <em class="icon ni ni-pen-fill"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-penyeliaanlk">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-penyeliaanlk">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Penyelia')) {
                                                                                if ($row_s1['tingkat_status1'] == 10) { ?>
                                                                                    <br>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-cetaksertifikat">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-cetaksertifikat">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            ...
                                                                            if ($row_s1['tingkat_status1'] > 11) { ?>
                                                                                <br>
                                                                                <button onclick="salinansertifikat_page(<?= $proyekid; ?>)" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </button>
                                                                                <span>&nbsp;</span>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Admin Umum')) {
                                                                                if ($row_s1['tingkat_status1'] == 11) { ?>
                                                                                    <br>
                                                                                    <button onclick="salinansertifikat_page(<?= $proyekid; ?>)" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary">
                                                                                        <em class="icon ni ni-pen-fill"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-salinansertifikat">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-salinansertifikat">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row_s1['tingkat_status1'] > 12) { ?>
                                                                                <br>
                                                                                <a href="<?= $row_bastsertifikat['link_bastsertifikat']; ?>" target="_blank" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </a>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Penyelia')) {
                                                                                if ($row_s1['tingkat_status1'] == 12) {
                                                                                    if ($row_jml_bastsertifikat == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-bastsertifikat">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                        <span>&nbsp;</span>
                                                                                    <?php } else { ?>
                                                                                        <button id="<?= $row_bastsertifikat['id_bastsertifikat']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-bastsertifikat">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                        <span>&nbsp;</span>
                                                                                    <?php } ?>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-bastsertifikat">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-bastsertifikat">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                        ...
                                                        <?php if ($row_s1['tingkat_status1'] == 13) { ?>
                                                            <div class="text-center">
                                                                <button id="<?= $proyekid; ?>" class="btn btn-dim btn-outline-danger btn-back-tla">Batal
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                                </div><!-- .card -->
                                                ...
                                                <div class="card h-100">
                                                    ...
                                                    <div class="card-inner">
                                                        <div class="timeline">
                                                            ...
                                                            <ul class="timeline-list">
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row_s2['tingkat_status2'] > 9) { ?>
                                                                                <br>
                                                                                <a href="<?= $row_inputdo['link_inputdo']; ?>" target="_blank" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </a>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Admin Umum')) {
                                                                                if ($row_s2['tingkat_status2'] == 9) {
                                                                                    if ($row_jml_inputdo == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-inputdo">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } else { ?>
                                                                                        <br>
                                                                                        <button id="<?= $row_inputdo['id_inputdo']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-inputdo">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } ?>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-inputdo">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-inputdo">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row_s2['tingkat_status2'] > 10) { ?>
                                                                                <br>
                                                                                <a href="<?= $row_invoicepajak['link_invoicepajak']; ?>" target="_blank" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </a>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Finance')) {
                                                                                if ($row_s2['tingkat_status2'] == 10) {
                                                                                    if ($row_jml_invoicepajak == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-invoicepajak">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } else { ?>
                                                                                        <button id="<?= $row_invoicepajak['id_invoicepajak']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-invoicepajak">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } ?>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-invoicepajak">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-invoicepajak">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        <?php if ($row_s2['tingkat_status2'] > 11) { ?>
                                                                            <strong class="tb-status text-success">SPJ</strong>
                                                                        <?php } else { ?>
                                                                            <strong class="tb-status text-muted">SPJ</strong>
                                                                        <?php } ?>
                                                                        <div class="timeline-des">
                                                                            <?php if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Finance')) {
                                                                                if ($row_s2['tingkat_status2'] == 11) { ?>
                                                                                    <br>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-spj">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-spj">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row_s2['tingkat_status2'] > 12) { ?>
                                                                                <br>
                                                                                <a href="<?= $row_buktitransfer['link_buktitransfer']; ?>" target="_blank" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </a>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Finance')) {
                                                                                if ($row_s2['tingkat_status2'] == 12) {
                                                                                    if ($row_jml_buktitransfer == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-buktitransfer">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                        <span>&nbsp;</span>
                                                                                    <?php } else { ?>
                                                                                        <button id="<?= $row_buktitransfer['id_buktitransfer']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-buktitransfer">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                        <span>&nbsp;</span>
                                                                                    <?php } ?>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-buktitransfer">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-buktitransfer">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row_s2['tingkat_status2'] > 13) { ?>
                                                                                <br>
                                                                                <a href="<?= $row_sppbuktipotong['link_sppbuktipotong']; ?>" target="_blank" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </a>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Finance')) {
                                                                                if ($row_s2['tingkat_status2'] == 13) {
                                                                                    if ($row_jml_sppbuktipotong == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-sppbuktipotong">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                        <span>&nbsp;</span>
                                                                                    <?php } else { ?>
                                                                                        <button id="<?= $row_sppbuktipotong['id_sppbuktipotong']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-sppbuktipotong">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                        <span>&nbsp;</span>
                                                                                    <?php } ?>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-sppbuktipotong">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-sppbuktipotong">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                        ...
                                                        <?php if ($row_s2['tingkat_status2'] == 14) { ?>
                                                            <div class="text-center">
                                                                <button id="<?= $proyekid; ?>" class="btn btn-dim btn-outline-danger btn-back-tlb">Batal
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                                </div><!-- .card -->
                                                ...
                                                <div class="card h-100">
                                                    ...
                                                    <div class="card-inner">
                                                        <div class="timeline">
                                                            ...
                                                            <ul class="timeline-list">
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row_s3['tingkat_status3'] > 9) { ?>
                                                                                <br>
                                                                                <a href="<?= $row_posubkontrak['link_posubkontrak']; ?>" target="_blank" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </a>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Admin Umum')) {
                                                                                if ($row_s3['tingkat_status3'] == 9) {
                                                                                    if ($row_jml_posubkontrak == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-posubkontrak">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } else { ?>
                                                                                        <br>
                                                                                        <button id="<?= $row_posubkontrak['id_posubkontrak']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-posubkontrak">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } ?>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-posubkontrak">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-posubkontrak">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row_s3['tingkat_status3'] > 10) { ?>
                                                                                <br>
                                                                                <a href="<?= $row_kirimsubkontrak['link_kirimsubkontrak']; ?>" target="_blank" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </a>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Admin Teknis')) {
                                                                                if ($row_s3['tingkat_status3'] == 10) {
                                                                                    if ($row_jml_kirimsubkontrak == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-kirimsubkontrak">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } else { ?>
                                                                                        <button id="<?= $row_kirimsubkontrak['id_kirimsubkontrak']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-kirimsubkontrak">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } ?>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-kirimsubkontrak">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-kirimsubkontrak">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row_s3['tingkat_status3'] > 11) { ?>
                                                                                <br>
                                                                                <a href="<?= $row_uangsubkontrak['link_uangsubkontrak']; ?>" target="_blank" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </a>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Finance')) {
                                                                                if ($row_s3['tingkat_status3'] == 11) {
                                                                                    if ($row_jml_uangsubkontrak == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-uangsubkontrak">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } else { ?>
                                                                                        <button id="<?= $row_uangsubkontrak['id_uangsubkontrak']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-uangsubkontrak">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } ?>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-uangsubkontrak">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-uangsubkontrak">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row_s3['tingkat_status3'] > 12) { ?>
                                                                                <br>
                                                                                <a href="<?= $row_invoicepajaksubkontrak['link_invoicepajaksubkontrak']; ?>" target="_blank" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </a>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Finance')) {
                                                                                if ($row_s3['tingkat_status3'] == 12) {
                                                                                    if ($row_jml_invoicepajaksubkontrak == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-invoicepajaksubkontrak">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } else { ?>
                                                                                        <button id="<?= $row_invoicepajaksubkontrak['id_invoicepajaksubkontrak']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-invoicepajaksubkontrak">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                    <?php } ?>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-invoicepajaksubkontrak">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-invoicepajaksubkontrak">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        <?php if ($row_s3['tingkat_status3'] > 13) { ?>
                                                                            <strong class="tb-status text-success">Verifikasi
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row_s3['tingkat_status3'] > 13) { ?>
                                                                                <br>
                                                                                <button onclick="verifikasibelisubkontrak_pdf(<?= $proyekid; ?>)" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </button>
                                                                                <span>&nbsp;</span>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Admin Umum')) {
                                                                                if ($row_s3['tingkat_status3'] == 13) { ?>
                                                                                    <br>
                                                                                    <button onclick="verifikasibelisubkontrak_page(<?= $proyekid; ?>)" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary">
                                                                                        <em class="icon ni ni-pen-fill"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-verifikasibelisubkontrak">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-verifikasibelisubkontrak">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-data">
                                                                        ...
                                                                        <div class="timeline-des">
                                                                            <?php if ($row_s3['tingkat_status3'] > 14) { ?>
                                                                                <br>
                                                                                <a href="<?= $row_bastalat['link_bastalat']; ?>" target="_blank" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-info">
                                                                                    <em class="icon ni ni-info-i"></em>
                                                                                </a>
                                                                                <?php }
                                                                            if (($row_session['posisi_user'] == 'SA') || ($row_session['posisi_user'] == 'Penyelia')) {
                                                                                if ($row_s3['tingkat_status3'] == 14) {
                                                                                    if ($row_jml_bastalat == 0) { ?>
                                                                                        <br>
                                                                                        <button data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-bastalat">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                        <span>&nbsp;</span>
                                                                                    <?php } else { ?>
                                                                                        <button id="<?= $row_bastalat['id_bastalat']; ?>" data-toggle="modal" data-target="#addProyekDetail" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-primary btn-edit-bastalat">
                                                                                            <em class="icon ni ni-pen-fill"></em>
                                                                                        </button>
                                                                                        <span>&nbsp;</span>
                                                                                    <?php } ?>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-success btn-ok-bastalat">
                                                                                        <em class="icon ni ni-check-thick"></em>
                                                                                    </button>
                                                                                    <span>&nbsp;</span>
                                                                                    <button id="<?= $proyekid; ?>" class="btn btn-round btn-icon btn-sm btn-dim btn-outline-danger btn-not-bastalat">
                                                                                        <em class="icon ni ni-cross"></em>
                                                                                    </button>
                                                                            <?php }
                                                                            } ?>
                                                        ...
                                                        <?php if ($row_s3['tingkat_status3'] == 15) { ?>
                                                            <div class="text-center">
                                                                <button id="<?= $proyekid; ?>" class="btn btn-dim btn-outline-danger btn-back-tlc">Batal
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="hl_form" name="hl_form" class="form-validate is-alter" novalidate="novalidate">
                                    ...
                                    <input type="hidden" id="id_proyek" name="id_proyek" value="<?= $row0['id_proyek']; ?>" />
                                    <input type="hidden" id="form_name" name="form_name" value="add_permintaan_order" />
                                    <input type="hidden" id="id_permintaan_order" name="id_permintaan_order" value="0" />
                                    ...
                                    <input type="hidden" id="id_invoicepajaksubkontrak" name="id_invoicepajaksubkontrak" value="0" />
                                    ...
                                    <div class="form-group" id="tgl1_permintaan_order_form">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="text" class="form-control date-picker invalid" data-date-format="yyyy-mm-dd" id="tgl1_permintaan_order" name="tgl1_permintaan_order">
                                        </div>
                                    ...
                                    <div class="form-group" id="tgl2_permintaan_order_form">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="text" class="form-control date-picker invalid" data-date-format="yyyy-mm-dd" id="tgl2_permintaan_order" name="tgl2_permintaan_order">
                                        </div>
                                        <div class="form-note">
                                            Date
                                            format
                                    ...
                                    <div class="form-group" id="link_permintaan_order_form">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="link_permintaan_order" name="link_permintaan_order" placeholder="Link Order" required data-msg="Mohon isi link order">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="akomodasi_kajiulangmain_form">
                                        <label class="form-label" for="akomodasi_kajiulangmain">Akomodasi
                                            kajiulang</label>
                                        <div class="form-control-wrap"><input type="number" min="0" class="form-control invalid" id="akomodasi_kajiulangmain" name="akomodasi_kajiulangmain" required data-msg="Mohon isi akomodasi kajiulang" placeholder="Akomodasi kajiulang">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="no_penawaranharga_form">
                                        <label class="form-label" for="no_penawaranharga">Nomor
                                            Penawaran</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="no_penawaranharga" name="no_penawaranharga" placeholder="Nomor Penawaran" required data-msg="Mohon isi nomor penawaran">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="nilai_penawaranharga_form">
                                        <label class="form-label" for="nilai_penawaranharga">Nilai
                                            Penawaran</label>
                                        <div class="form-control-wrap"><input type="number" min="0" class="form-control invalid" id="nilai_penawaranharga" name="nilai_penawaranharga" required data-msg="Mohon isi nilai penawaran" placeholder="Nilai Penawaran">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="link_penawaranharga_form">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="link_penawaranharga" name="link_penawaranharga" placeholder="Link Order" required data-msg="Mohon isi link order">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="nilai_negosiasi_form">
                                        ...
                                        <div class="form-control-wrap"><input type="number" min="0" class="form-control invalid" id="nilai_negosiasi" name="nilai_negosiasi" required data-msg="Mohon isi nilai negosiasi" placeholder="Nilai Negosiasi">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="subkontrak_negosiasi_form">
                                        ...
                                        <div class="form-control-wrap">
                                            <div class="form-control-select">
                                                <select class="form-control" required data-msg="Mohon isi subkontrak" name="subkontrak_negosiasi" id="subkontrak_negosiasi">
                                    ...
                                    <div class="form-group" id="link_negosiasi_form">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="link_negosiasi" name="link_negosiasi" placeholder="Link Negosiasi" required data-msg="Mohon isi link negosiasi">
                                        </div>
                                    </div>

                                    <!-- ============================== spk ============================== -->

                                    <div class="form-group" id="up_spk_form">
                                        <label class="form-label" for="up_spk">UP</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="up_spk" name="up_spk" placeholder="UP SPK" required data-msg="Mohon isi up SPK">
                                        </div>
                                    </div>

                                    <div class="form-group" id="hp_spk_form">
                                        <label class="form-label" for="hp_spk">HP</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="hp_spk" name="hp_spk" placeholder="HP SPK" required data-msg="Mohon isi hp SPK">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3" id="akomodasi_spk_form">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input id="jml_tek_akomodasi_spk" name="jml_tek_akomodasi_spk" type="number" min="0" class="form-control invalid" placeholder="Jml Teknisi" required data-msg="Mohon isi jumlah teknisi">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input id="jml_hari_akomodasi_spk" name="jml_hari_akomodasi_spk" type="number" min="0" class="form-control invalid" placeholder="Jml Hari" required data-msg="Mohon isi jumlah hari">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input id="jml_nominal_akomodasi_spk" name="jml_nominal_akomodasi_spk" type="number" min="0" class="form-control invalid" placeholder="Nominal" required data-msg="Mohon isi nominal">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3" id="bbm_spk_form">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input id="jml_tek_bbm_spk" name="jml_tek_bbm_spk" type="number" min="0" class="form-control invalid" placeholder="Jml Teknisi" required data-msg="Mohon isi jumlah teknisi">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input id="jml_hari_bbm_spk" name="jml_hari_bbm_spk" type="number" min="0" class="form-control invalid" placeholder="Jml Hari" required data-msg="Mohon isi jumlah hari">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input id="jml_nominal_bbm_spk" name="jml_nominal_bbm_spk" type="number" min="0" class="form-control invalid" placeholder="Nominal" required data-msg="Mohon isi nominal">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3" id="penginapan_spk_form">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input id="jml_tek_penginapan_spk" name="jml_tek_penginapan_spk" type="number" min="0" class="form-control invalid" placeholder="Jml Teknisi" required data-msg="Mohon isi jumlah teknisi">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input id="jml_hari_penginapan_spk" name="jml_hari_penginapan_spk" type="number" min="0" class="form-control invalid" placeholder="Jml Hari" required data-msg="Mohon isi jumlah hari">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input id="jml_nominal_penginapan_spk" name="jml_nominal_penginapan_spk" type="number" min="0" class="form-control invalid" placeholder="Nominal" required data-msg="Mohon isi nominal">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3" id="supir_spk_form">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input id="jml_tek_supir_spk" name="jml_tek_supir_spk" type="number" min="0" class="form-control invalid" placeholder="Jml Teknisi" required data-msg="Mohon isi jumlah teknisi">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input id="jml_hari_supir_spk" name="jml_hari_supir_spk" type="number" min="0" class="form-control invalid" placeholder="Jml Hari" required data-msg="Mohon isi jumlah hari">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input id="jml_nominal_supir_spk" name="jml_nominal_supir_spk" type="number" min="0" class="form-control invalid" placeholder="Nominal" required data-msg="Mohon isi nominal">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="link_lappekerjaan_form">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="link_lappekerjaan" name="link_lappekerjaan" placeholder="Link Laporan Pekerjaan" required data-msg="Mohon isi link laporan pekerjaan">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="link_bastsertifikat_form">
                                        <label class="form-label" for="link_bastsertifikat">Link BAST
                                            Sertifikat</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="link_bastsertifikat" name="link_bastsertifikat" placeholder="Link bastsertifikat" required data-msg="Mohon isi link bastsertifikat">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="link_inputdo_form">
                                        <label class="form-label" for="link_inputdo">Link
                                            Input DO</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="link_inputdo" name="link_inputdo" placeholder="Link inputdo" required data-msg="Mohon isi link inputdo">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="nilai_invoicepajak_form">
                                        ...
                                        <div class="form-control-wrap"><input type="number" min="0" class="form-control invalid" id="nilai_invoicepajak" name="nilai_invoicepajak" required data-msg="Mohon isi nilai invoice pajak" placeholder="Nilai invoice pajak">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="link_invoicepajak_form">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="link_invoicepajak" name="link_invoicepajak" placeholder="Link invoicepajak" required data-msg="Mohon isi link invoicepajak">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="link_buktitransfer_form">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="link_buktitransfer" name="link_buktitransfer" placeholder="Link buktitransfer" required data-msg="Mohon isi link buktitransfer">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="link_sppbuktipotong_form">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="link_sppbuktipotong" name="link_sppbuktipotong" placeholder="Link sppbuktipotong" required data-msg="Mohon isi link sppbuktipotong">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="link_posubkontrak_form">
                                        <label class="form-label" for="link_posubkontrak">Link
                                            PO Subkontrak</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="link_posubkontrak" name="link_posubkontrak" placeholder="Link posubkontrak" required data-msg="Mohon isi link posubkontrak">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="link_kirimsubkontrak_form">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="link_kirimsubkontrak" name="link_kirimsubkontrak" placeholder="Link kirimsubkontrak" required data-msg="Mohon isi link kirimsubkontrak">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="link_uangsubkontrak_form">
                                        <label class="form-label" for="link_uangsubkontrak">Link Pelunasan / Uang
                                            Muka</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="link_uangsubkontrak" name="link_uangsubkontrak" placeholder="Link uangsubkontrak" required data-msg="Mohon isi link uangsubkontrak">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="link_invoicepajaksubkontrak_form">
                                        <label class="form-label" for="link_invoicepajaksubkontrak">Link Invoice dan
                                            ...
                                            Subkontrak</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="link_invoicepajaksubkontrak" name="link_invoicepajaksubkontrak" placeholder="Link invoicepajaksubkontrak" required data-msg="Mohon isi link invoicepajaksubkontrak">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="link_bastalat_form">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control invalid" id="link_bastalat" name="link_bastalat" placeholder="Link bastalat" required data-msg="Mohon isi link bastalat">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3" id="btn_kajiulang_form">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-lg btn-primary btn-submit-kajiulang">Simpan
                                                    Akomodasi</button>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group text-right">
                                                <a href="#" onclick="kajiulang_page(<?= $proyekid; ?>)" class="btn btn-lg btn-info">Input Data Alat</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group" id="btn_penawaranharga_form">
                                        <button type="submit" class="btn btn-lg btn-primary btn-submit-penawaranharga">Simpan
                                            Penawaran</button>
                                    </div>
                                    ...
                                    <div class="row g-3" id="btn_spk_form">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-lg btn-primary btn-submit-spk">Simpan
                                                    SPK</button>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group text-right">
                                                <a href="#" onclick="spk_page(<?= $proyekid; ?>)" class="btn btn-lg btn-info">Lihat
                                                    Data Alat</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group" id="btn_lappekerjaan_form">
                                        <button type="submit" class="btn btn-lg btn-primary btn-submit-lappekerjaan">Simpan
                                            Laporan Pekerjaan</button>
                                    </div>
                                    <div class="form-group" id="btn_bastsertifikat_form">
                                        <button type="submit" class="btn btn-lg btn-primary btn-submit-bastsertifikat">Simpan
                                    ...
                                    <div class="form-group" id="btn_invoicepajak_form">
                                        <button type="submit" class="btn btn-lg btn-primary btn-submit-invoicepajak">Simpan
                                            Invoice dan Pajak</button>
                                    </div>
                                    <div class="form-group" id="btn_buktitransfer_form">
                                        <button type="submit" class="btn btn-lg btn-primary btn-submit-buktitransfer">Simpan Bukti
                                            Transfer</button>
                                    </div>
                                    <div class="form-group" id="btn_sppbuktipotong_form">
                                        <button type="submit" class="btn btn-lg btn-primary btn-submit-sppbuktipotong">Simpan
                                            SPP Bukti Potong</button>
                                    </div>

                                    <div class="form-group" id="btn_posubkontrak_form">
                                        <button type="submit" class="btn btn-lg btn-primary btn-submit-posubkontrak">Simpan
                                            PO Subkontrak</button>
                                    </div>
                                    <div class="form-group" id="btn_kirimsubkontrak_form">
                                        <button type="submit" class="btn btn-lg btn-primary btn-submit-kirimsubkontrak">Simpan
                                            Kirim Subkontrak</button>
                                    </div>
                                    <div class="form-group" id="btn_uangsubkontrak_form">
                                        <button type="submit" class="btn btn-lg btn-primary btn-submit-uangsubkontrak">Simpan
                                            Uang Muka / Pelunasan</button>
                                    </div>
                                    <div class="form-group" id="btn_invoicepajaksubkontrak_form">
                                        <button type="submit" class="btn btn-lg btn-primary btn-submit-invoicepajaksubkontrak">Simpan
