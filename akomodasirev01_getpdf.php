    ...
    <table id="myTable" border="0.05px" cellspacing="0" style="width: 90%; text-align: center; font-size: 10px; padding-top: 0px; margin-left: 45px; color: #000000; ">
        ...
        <tr>
            ...
            <td style="width: 34%; ">
                ...
                <br>
				&nbsp;&nbsp;&nbsp;
				<img style="width: 45%;" src="./images/img/ttd_putu_new.jpg">
				<br>
                (I Putu Cahya Gunawan)
				<br>
                <b>Manager Teknik</b>
            </td>
            <td style="width: 33%; ">
            ...
            <thead>
                <tr>
                    ...
                    <th rowspan="5" style="color: #000000;">
                        ...
                        <br>
						&nbsp;&nbsp;&nbsp;
						<img style="width: 63%;" src="./images/img/ttd_putu_new.jpg">
						<br>
                        (I Putu Cahya Gunawan)
						<br>
                        Manager Teknik
