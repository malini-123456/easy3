...
if (isset($_SESSION['username_pelanggan'])) {
    ...
    header("location:sertifikat_user");
}
?>
                                ...
                                <form action="" method="post" role="form" id="login-frm" class="form-validate">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control form-control-lg" id="username_pelanggan" name="username_pelanggan" placeholder="Username" required value="<?php if (isset($_COOKIE['username_pelanggan'])) {
                                                                                                                                                                                                    echo $_COOKIE['username_pelanggan'];
                                                                                                                                                                                                } ?>">
                                        </div>
                                    </div><!-- .form-group -->
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <label class="form-label" for="pass_pelanggan">Password</label>
                                        </div>
                                        <div class="form-control-wrap">
                                            <a tabindex="-1" href="#" class="form-icon form-icon-right passcode-switch" data-target="pass_pelanggan">
                                                <em class="passcode-icon icon-show icon ni ni-eye"></em>
                                                <em class="passcode-icon icon-hide icon ni ni-eye-off"></em>
                                            </a>
                                            <input type="password" class="form-control form-control-lg" id="pass_pelanggan" name="pass_pelanggan" placeholder="Password" required value="<?php if (isset($_COOKIE['pass_pelanggan'])) {
                                                                                                                                                                                                echo $_COOKIE['pass_pelanggan'];
                                                                                                                                                                                            } ?>">
                                        </div>
                                    </div><!-- .foem-group -->
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="rem" class="custom-control-input" id="customCheck" <?php if (isset($_COOKIE['username_pelanggan'])) { ?> checked <?php } ?>>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" id="login" name="login" class="btn btn-lg btn-primary btn-block">Sign in</button>
                                    </div>
                                </form>
                                    ...
                                    <div class="slider-item">
                                        <div class="nk-feature nk-feature-center">
                                            <div class="nk-feature-img">
                                                <img class="round" src="./images/slides/ens_1.jpg" srcset="./images/slides/ens_1.jpg 2x" alt="">
                                            </div>
                                        </div>
                                    </div><!-- .slider-item -->
                                    <div class="slider-item">
                                        <div class="nk-feature nk-feature-center">
                                            <div class="nk-feature-img">
                                                <img class="round" src="./images/slides/ens_2.jpg" srcset="./images/slides/ens_2.jpg 2x" alt="">
                                            </div>
                                        </div>
                                    </div><!-- .slider-item -->
                                </div><!-- .slider-init -->
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response == "ok0") {
                                ...
                                console.log('sertifikatrev_user');
                                window.open('sertifikatrev_user', '_self');
                            } else {
