                    ...
                    <div class="nk-block nk-block-middle wide-md mx-auto">
                        <div class="nk-block-content nk-error-ld text-center">
                            ...
                            <div class="wide-xs mx-auto">
                                <h3 class="nk-error-title">EASY3 dalam perbaikan!</h3>
                                <p class="nk-error-text">Mohon maaf saat ini website EASY3 sedang dalam perbaikan.</p>
                                <!-- <a href="home" class="btn btn-lg btn-primary mt-2">Kembali</a> -->
                            </div>
                        </div>
                    </div><!-- .nk-block -->
                </div>
