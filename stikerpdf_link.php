...
<body class="nk-body bg-lighter npc-default has-sidebar ">
            ...
            if ($("#hl_form").valid() == true) {
                ...
                if (validate_angka(code_angka) == false) {
                    ...
                    if (code_huruf == 'H' || code_huruf == 'h') {
                        ...
                        cetak_stiker(code, code_huruf, code_angka, cetak_stiker);
                        // cetak_stiker(code);
    ...
    //     let link = 'stiker2_pdf?kode=' + kode;
    ...
    async function cetak_stiker(kode, churuf, cangka, callbackFn) {
        let link = 'stiker2_pdf?kode=' + kode;
        window.open(link, '_blank');
        console.log('Ke-' + i + ' = ' + kode);
        ...
        if (i < 1000) {
            ...
            kode = churuf + cangka;
            callbackFn(kode, churuf, cangka, callbackFn);
        }
    }
    </script>
